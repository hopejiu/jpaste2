  ...
  return (
    <div class="settings-page">
      ...
      <div class="settings-body">
        ...
        <div class="settings-section row">
          <div>
            <div class="settings-section-title">队列清空后恢复常态</div>
            <div class="settings-section-desc">队列模式下内容全部粘贴或清空后，自动切换回正常模式</div>
          </div>
          <ToggleSwitch
            checked={local.queue_auto_reset}
            onChange={() => handleSave({ queue_auto_reset: !local.queue_auto_reset })}
          />
        </div>
